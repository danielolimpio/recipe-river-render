...
const Contact = () => {
  return (
    <Layout>
      <SEO
        title="Contato — Culinária Fitness"
        description="Fale com a equipe Culinária Fitness: tire dúvidas, envie sua receita ou proponha parcerias. Respondemos em até 5 dias úteis."
        path="/contato"
      />
      <PageBanner
        title="Contato"
